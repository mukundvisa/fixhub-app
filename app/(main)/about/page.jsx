...
const page = () => {
  return (
    <>
      ...
      <main className="min-h-screen bg-white dark:bg-black text-gray-800 dark:text-gray-200 transition-colors">
        {/* Mission Vision */}
        <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 py-16">
          <div className="p-6 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5">
            <h2 className="text-2xl font-semibold mb-3">Our Mission</h2>
            <p className="text-gray-600 dark:text-gray-400">
              To create a reliable knowledge hub where developers can quickly
              find solutions, share fixes, and reduce time spent debugging.
            </p>
          </div>
